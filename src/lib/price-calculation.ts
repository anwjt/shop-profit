...
export const PLATFORM_FEES: { [key: string]: { [key: string]: { name: string, fee: number, orderFee?: number, paymentFee?: number } } } = {
  shopee: {
    ...
    'shopee-large-appliance': { name: 'เครื่องใช้ไฟฟ้าใหญ่ (แอร์/ตู้เย็น/เครื่องซักผ้า)', fee: 5.35, paymentFee: 3.21 },
    ...
    'shopee-small-appliance': { name: 'เครื่องใช้ไฟฟ้าเล็ก (หม้อหุงข้าว/เตารีด/พัดลม)', fee: 6.42, paymentFee: 3.21 },
    'shopee-storage': { name: 'อุปกรณ์เก็บข้อมูล (Storage / Hard Disk)', fee: 6.42, paymentFee: 3.21 },
    'shopee-printer': { name: 'ปริ้นเตอร์และอุปกรณ์ (Printers)', fee: 6.42, paymentFee: 3.21 },
    ...
    'shopee-fashion': { name: 'แฟชั่น / เสื้อผ้า / รองเท้า / กระเป๋า', fee: 12.84, paymentFee: 3.21 },
    'shopee-wotch': { name: 'นาฬิกา / แว่นตา / เครื่องประดับ', fee: 12.84, paymentFee: 3.21 },
    'shopee-digital': { name: 'สินค้าดิจิทัล / บัตรเติมเงิน', fee: 12.84, paymentFee: 3.21 },
    'shopee-other': { name: 'สินค้าทั่วไป / อื่นๆ', fee: 12.84, paymentFee: 3.21 },
  },
  lazada: {
